<?php
/**
 * Verifies that Icms\Module\Entity retains its legacy icms_module_Object name.
 *
 * @package icms\tests
 */
...
namespace Icms\Tests\Unit\Module;
...
final class AliasesTest extends TestCase
{
    ...
    {
        return [
            'Module Entity' => ['Icms\\Module\\Entity', 'icms_module_Object'],
        ];
    }
