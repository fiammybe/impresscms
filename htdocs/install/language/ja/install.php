...
// Buttons
define("BUTTON_PREVIOUS", "<< 前のデータ"); // L42
define("BUTTON_NEXT", "次のデータ >>"); // L47
define("BUTTON_FINISH", "完了");
define("BUTTON_REFRESH", "更新");
...
define("ERR_INVALID_EMAIL", "無効なEmail"); // L73
...
define("_EXT_DATE_FUNC", "1"); // change 0 to 1 if this language has an extended date function

######################## Added in 1.2 ###################################
define("ADMIN_DISPLAY_LABEL", "Admin Display Name"); // L37
define('_CORE_PASSLEVEL1', '短すぎる');
define('_CORE_PASSLEVEL2', '弱');
define('_CORE_PASSLEVEL3', '良');
define('_CORE_PASSLEVEL4', '強');
