...
define("LANGUAGE_SELECTION_TITLE", "Choisissez la langue de l'assistance");		// L128
define("INTRODUCTION", "Introduction");
define("INTRODUCTION_TITLE", "Bienvenue dans l'assistance d'installation");		// L0
...
define("NO_PHP5_TITLE", "Pas de PHP 7");
...
define("_INSTALL_LOCAL_SITE", 'https://www.impresscms.fr/'); //Link to local support site
define("_LOCAOL_STNAME", 'ImpressCMS'); //Link to local support site
define("_LOCAL_SLOCGAN", 'Impressionnez votre public'); //Link to local support site
