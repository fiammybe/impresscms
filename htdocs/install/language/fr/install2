...
define("_INSTALL_ANONUSERS","Utilisateur(s) anonymes");
...
Votre compte a été activé avec succès sur {X_SITENAME}. En tant que membre de notre site, vous bénéficiez de toutes les fonctionnalités réservées aux membres enregistrés !

Bienvenue à nouveau sur notre site. Visitez-nous fréquemment !

Si vous n'avez pas inscrit sur notre site, veuillez nous contacter à l'adresse suivante {X_ADMINMAIL}, et nous résoudrons le problème.
