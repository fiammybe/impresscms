...
define("SHOW_HIDE_HELP", "Vis/skjul hjælpetekst");

define("ALTERNATE_LANGUAGE_MSG", "Download en alternativ sprogpakke fra ImpressCMS-webstedet");
define("ALTERNATE_LANGUAGE_LNK_MSG", "Vælg et andet sprog som ikke er vist her.");
define("ALTERNATE_LANGUAGE_LNK_URL", "https://sourceforge.net/projects/impresscms/files/ImpressCMS%20Languages/");
// Configuration check page
define("SERVER_API", "Server API");
define("PHP_EXTENSION", "%s udvidelse");
define("CHAR_ENCODING", "Tegnkodning");
define("XML_PARSING", "XML parsing");
define("REQUIREMENTS", "Forskrifter");
define("_PHP_VERSION", "PHP udgave");
define("RECOMMENDED_SETTINGS", "Anbefalede indstillinger");
define("RECOMMENDED_EXTENSIONS", "Anbefalede udvidelser");
define("SETTING_NAME", "Indstiller navn");
define("RECOMMENDED", "Anbefalet");
define("CURRENT", "Aktuel");
define("RECOMMENDED_EXTENSIONS_MSG", "Disse udvidelser er ikke nødvendige for normal brug, men kan være nødvendige for at udnytte
	- nogle specifikke funktioner (som multi-sprog eller RSS-support). Således anbefales det at have dem installeret.");
define("NONE", "Ingen");
define("SUCCESS", "Succes");
define("WARNING", "Advarsel");
define("FAILED", "Mislykket");

// Titles (main and pages)
define("XOOPS_INSTALL_WIZARD", " %s - Installationsguide");
define("INSTALL_STEP", "Skridt");
define("INSTALL_H3_STEPS", "Skridt");
define("INSTALL_OUTOF", " ud af ");
...
define("LANGUAGE_SELECTION", "Vælg sprog");
define("LANGUAGE_SELECTION_TITLE", "Vælg dit sprog");		// L128
define("INTRODUCTION", "Indledning");
define("INTRODUCTION_TITLE", "Velkommen til ImpressCMS installationsassistent");		// L0
define("CONFIGURATION_CHECK", "Konfigurationstjek");
define("CONFIGURATION_CHECK_TITLE", "Kontrollerer din server konfiguration");
define("PATHS_SETTINGS", "Stier indstillinger");
define("PATHS_SETTINGS_TITLE", "Stier indstillinger");
define("DATABASE_CONNECTION", "Database forbindelse");
define("DATABASE_CONNECTION_TITLE", "Database forbindelse");
define("DATABASE_CONFIG", "Database opsætning");
define("DATABASE_CONFIG_TITLE", "Database opsætning");
define("CONFIG_SAVE", "Gem konfiguration");
define("CONFIG_SAVE_TITLE", "Gemmer din systemkonfiguration");
define("TABLES_CREATION", "Oprettelse af tabeller");
define("TABLES_CREATION_TITLE", "Oprettelse af databasetabeller");
define("INITIAL_SETTINGS", "Indledende indstillinger");
define("INITIAL_SETTINGS_TITLE", "Indtast venligst dine oprindelige indstillinger");
