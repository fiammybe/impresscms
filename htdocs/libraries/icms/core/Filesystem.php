...
class icms_core_Filesystem
{
     ...
     */
    public static function mkdir($target, $mode = 0777, $base = ICMS_ROOT_PATH, $metachars = array()): bool
	{
 ...
 *@author  modified by David (fiammybe) Janssens <david.j@impresscms.org>
     ...
     */
    public static function cleanFolders($dirs, bool $remove_admin_cache = false): bool
	{
        global $icmsConfig;
     ...
     *
     */
    public static function cleanWriteFolders(): bool
	{
 ...
 */
     ...
     * @return  bool unlinked dirname
     */
    public static function deleteFile(string $dirname): bool
	{
     ...
     */
    public static function copyStream(string $src, string $dest): bool
	{
        $len = false;
     ...
     */
    public static function deleteRecursive($dir, $deleteRootToo = true): void
	{
        if (!is_dir($dir)) {
            return;
        }
     ...
     */
    public static function getDirList($dirname, array $ignore = array('cvs', '_darcs', '.svn'), $hideDot = true)
    {
        $dirList = array();
     ...
     */
    public static function getFileList($dirname, $prefix = '', array $extension = array(), bool $hideDot = false)
    {
        if (!is_dir($dirname)) {
            return array();
        }
    ...
    public static function writeFile($contents, $filename, $extension = '', $location = ICMS_TRUST_PATH)
    {
        if ($extension == '') {
            $extension = 'php';
        }
     ...
     */
    public static function getFileCount($dirname, $prefix = '', array $extension = array(), $hideDot = false): int
    {
 ...
 * is being completed
 */
    public static function getImgList($dirname, $prefix = '', $extension = array('gif', 'jpg', 'png'))
    {
        return self::getFileList($dirname, $prefix, $extension);
    }

    public static function getFontList($dirname, $prefix = '', $extension = array('ttf'))
    {
        return self::getFileList($dirname, $prefix, $extension);
    }

    public static function getPhpFiles($dirname, $prefix = '', $extension = array('php'))
    {
        return self::getFileList($dirname, $prefix, $extension);
    }

    public static function getHtmlFiles($dirname, $prefix = '', $extension = array('htm', 'html', 'xhtml'))
    {
        return self::getFileList($dirname, $prefix, $extension);
    }
