...
class Textsanitizer {
	...
	static public function getInstance() {
		static $instance;
		if (!isset($instance)) {
			$instance = new \Icms\Core\Textsanitizer();
		}
		return $instance;
	}
	...
	public function getSmileys($all = false) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::getSmileys', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::getSmileys($all);
	}
	...
	public function smiley($message) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::smiley', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::smiley($message);
	}
	...
	public function makeClickable(&$text) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::makeClickable', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::makeClickable($text);
	}
	...
	public function xoopsCodeDecode(&$text, $allowimage = 1) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::codeDecode', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::codeDecode($text, $allowimage);
	}
	...
	public function nl2Br($text) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::nl2Br', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::nl2Br($text);
	}
	...
	public function addSlashes($text) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::addSlashes', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::addSlashes($text);
	}
	...
	public function stripSlashesGPC($text) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::stripSlashesGPC', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::stripSlashesGPC($text);
	}
	...
	public function htmlSpecialChars($text) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::htmlSpecialchars', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::htmlSpecialChars($text);
	}
	...
	static public function undoHtmlSpecialChars($text) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::undoHtmlSpecialChars', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::undoHtmlSpecialChars($text);
	}

	public function icms_htmlEntities($text) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::htmlEntities', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::htmlEntities($text);
	}
	...
	public function displayTarea($text, $html = 0, $smiley = 1, $xcode = 1, $image = 1, $br = 1) {
		...
		//\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::checkVar - type = text or html, $options1 = input or output', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		...
		if ($html === 0){
			...
			$text = \Icms\Core\DataFilter::filterHTMLdisplay($text, $xcode, $br);
		}
	...
	public function previewTarea($text, $html = 0, $smiley = 1, $xcode = 1, $image = 1, $br = 1) {
		 /* @deprecated Use \Icms\Core\DataFilter::checkVar, instead - the events for previewTarea need to be added, first */
		//\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::checkVar - type = text or html, $options1 = input', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	...
	public function censorString(&$text) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::censorString', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::censorString($text);
	}
	...
	public function codePreConv($text, $xcode = 1) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::codePreConv', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::codePreConv($text, $xcode);
	}
	...
	public function codeConv($text, $xcode = 1, $image = 1) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::codeConv', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::codeConv($text, $xcode, $image);
	}
	...
	public function codeSanitizer($str, $image = 1) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::codeSanitizer', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::codeSanitizer($str, $image);
	}
	...
	function sanitizeForDisplay($text, $allowhtml = 0, $smiley = 1, $bbcode = 1) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::checkVar - type = text or html, $options1 = output', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		if ($allowhtml == 0)
		{
			$text = \Icms\Core\DataFilter::htmlSpecialChars($text);
		} else {
			$text = \Icms\Core\DataFilter::makeClickable($text);
		}
		if ($smiley == 1)
		{
			$text = \Icms\Core\DataFilter::smiley($text);
		}
		if ($bbcode == 1)
		{
			$text = \Icms\Core\DataFilter::codeDecode($text);
		}
		$text = \Icms\Core\DataFilter::nl2Br($text);
		return $text;
	}
	...
	function sanitizeForPreview($text, $allowhtml = 0, $smiley = 1, $bbcode = 1) {
		\Icms\Core\Debug::setDeprecated('icms_core_DataFilter->checkVar - type = text or html, options1 = input', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	...
	function makeTboxData4Edit($text) {
		\Icms\Core\Debug::setDeprecated('icms_core_Datafilter::htmlSpecialChars', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::htmlSpecialChars($text);
	}
	...
	function makeTboxData4Preview($text, $smiley=0) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::htmlSpecialChars and \Icms\Core\DataFilter::stripSlashesGPC', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		$text = \Icms\Core\DataFilter::stripSlashesGPC($text);
		return \Icms\Core\DataFilter::htmlSpecialChars($text);
	}
	...
	/**
	 *
	 * @deprecated	\Icms\Core\DataFilter::checkVar - type = text
	 * @todo		Remove this in version 1.4
	 *
	 * @param str	$text
	 */
	function makeTareaData4PreviewInForm($text) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::checkVar - type = text, options1 = input', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		$text = \Icms\Core\DataFilter::stripSlashesGPC($text);
		return \Icms\Core\DataFilter::htmlSpecialChars($text);
	}
	...
	public function icmsCodeDecode_extended($text, $allowimage = 1) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::codeDecode_extended', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::codeDecode_extended($text, $allowimage);
	}
	...
	public function icmsloadExtension($name) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::loadExtension', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::loadExtension($name);
	}
	...
	public function icmsExecuteExtension($name, $text) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::executeExtension', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::executeExtension($name, $text);
	}
	...
	public function textsanitizer_syntaxhighlight(&$text) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::textsanitizer_syntaxhighlight', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::textsanitizer_syntaxhighlight($text);
	}
	...
	public function textsanitizer_php_highlight($text) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::textsanitizer_php_highlight', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::textsanitizer_php_highlight($text);
	}
	...
	public function textsanitizer_geshi_highlight($text) {
		\Icms\Core\Debug::setDeprecated('\Icms\Core\DataFilter::textsanitizer_geshi_highlight', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return \Icms\Core\DataFilter::textsanitizer_geshi_highlight($text);
	}
}
