...
class Table {
	...
	public function setSortOrder() {
		// FILTER_SANITIZE_STRING was removed in PHP 8.1; strip_tags + FILTER_DEFAULT is the equivalent.
		$this->_sortsel = isset($_GET[$this->_objectHandler->_itemname . '_' . 'sortsel']) ? strip_tags((string) filter_input(INPUT_GET, $this->_objectHandler->_itemname . '_' . 'sortsel', FILTER_DEFAULT)) : $this->getDefaultSort();
		...
		// FILTER_SANITIZE_STRING was removed in PHP 8.1; strip_tags + FILTER_DEFAULT is the equivalent.
		$this->_ordersel = isset($_GET[$this->_objectHandler->_itemname . '_' . 'ordersel']) ? strip_tags((string) filter_input(INPUT_GET, $this->_objectHandler->_itemname . '_' . 'ordersel', FILTER_DEFAULT)) : $this->getDefaultOrder();
