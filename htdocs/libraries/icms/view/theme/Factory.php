...
class Factory
{
    ...
    public static function getThemesList()
    {
        ...
        return is_array($cleanList) ? $cleanList : [];
    }

    /**
     * Gets list of administration themes folder from themes directory,
	 * excluding any directories that do not have theme_admin.html
     * @return  array
     */
    public static function getAdminThemesList()
    {
        ...
        foreach ($dirtyList2 as $item2) {
            if (
                file_exists(ICMS_MODULES_PATH . '/system/themes/' . $item2 . '/theme.html')
