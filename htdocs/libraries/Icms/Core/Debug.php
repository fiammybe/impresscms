...
class Debug
{
     ...
     */
    public static function message(string $msg, bool $exit = false): void
    {
     ...
     */
    public static function setDeprecated(string $replacement = '', string $extra = ''): void
    {
            ...
            foreach ($trace as $step) {
                ...
                if (isset($step['file'])) {
                    $message .= $level . $msg
                        ...
                        . sprintf(
                            _CORE_DEPRECATED_MSG,
                            $step['function'],
                            str_replace(
                                [ICMS_TRUST_PATH, ICMS_ROOT_PATH],
                                ["TRUSTPATH", "ROOTPATH"],
                                $step['file']
                            ),
                            $step['line']
