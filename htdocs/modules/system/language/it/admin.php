...
define('_MD_AM_MDAD','Amministrazione Moduli');
define('_MD_AM_SMLS','Faccine');
define('_MD_AM_RANK','Classifica utenti');
define('_MD_AM_USER','Edit Users');
define('_MD_AM_FINDUSER', 'Trova Utenti');
define('_MD_AM_PREF','Preferenze');
define('_MD_AM_VRSN','Controllo versione');
define('_MD_AM_MLUS', 'Utenti email');
define('_MD_AM_IMAGES', 'Gestore immagini');
define('_MD_AM_AVATARS', 'Avatar');
define('_MD_AM_TPLSETS', 'Modelli');
define('_MD_AM_COMMENTS', 'Commenti');
define('_MD_AM_BKPOSAD','Posizioni Blocchi');
define('_MD_AM_PAGES','Gestore Symlink');
