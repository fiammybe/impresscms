...
if (!defined('_AM_DBUPDATED')) {define("_AM_DBUPDATED","Base de datos actualizada con éxito");}
...
define("_AM_PASSWORD","Contraseña");
...
define("_AM_USERID","ID de Usuario");
...
define("_AM_USERS_DELETEED","borrar");
