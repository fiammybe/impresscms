...
if (!defined('_AM_DBUPDATED')) {if (!defined('_AM_DBUPDATED')) {define("_AM_DBUPDATED","Base de données mise à jour correctement!");}}
...
define("_AM_OPTIONS","Options de notification");
...
define('_AM_CLONE', 'Cloner');  // clone a block
define('_AM_CLONEBLK', 'Clon&eacute;'); // cloned block
define('_AM_CLONEBLOCK', 'Cr&eacute;er un bloc clone');
define('_AM_NOTSELNG', "'%s' n'est pas s&eacute;lectionn&eacute; !"); // error message
...
define("_CO_SYSTEM_BLOCKSADMIN_OPTIONS", "Options de notification");
