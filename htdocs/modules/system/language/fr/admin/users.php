...
if (!defined('_AM_DBUPDATED')) {define("_AM_DBUPDATED","Base de données mise à jour correctement!");}
...
define("_AM_YIM","YIM");
define("_AM_MSNM","MSN");
define("_AM_LOCATION","Ville");
define("_AM_OCCUPATION","Profession");
define("_AM_INTEREST","Centres d'int&eacute;r&ecirc;ts");
...
define("_AM_INDICATECOF","* indique les champs requis");
...
define("_AM_USERID","Num&eacute;ro ID Utilisateur");
...
define('_AM_BADPWD','Mot de passe incorrect, le mot de passe ne peut pas contenir le nom de l\'utilisateur.');
...
define("_AM_USERS_DELETEED","supprim&eacute;");
