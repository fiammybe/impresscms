...
define('_CO_ICMS_CATEGORY_DESCRIPTION', '説明');
...
define('_CO_ICMS_CATEGORY_IMAGE', 'イメージ');
...
define('_CO_ICMS_DEVELOPER_CONTRIBUTOR', '寄稿者');
define('_CO_ICMS_DEVELOPER_CREDITS', 'Credits');
define('_CO_ICMS_DEVELOPER_EMAIL', 'メール');
define('_CO_ICMS_DEVELOPER_WEBSITE', 'ホームページ');
...
define('_CO_ICMS_MODULE_INFO', 'モジュール開発情報');
define('_CO_ICMS_MODULE_RELEASE_DATE', 'リリース日');
define('_CO_ICMS_MODULE_STATUS', 'Status');
define('_CO_ICMS_MODULE_SUBMIT_BUG', 'バグ情報を送信');
define('_CO_ICMS_MODULE_SUBMIT_FEATURE', '新機能を要望');
...
define('_CO_ICMS_SUBMIT', '提出する');
define('_CO_ICMS_TAG_DESCRIPTION_CAPTION', "説明");
...
define('_CO_ICMS_UPDATE_MODULE', 'モジュールアップデート');
define('_CO_ICMS_UPLOAD_IMAGE', 'Upload a new image :');
define('_CO_ICMS_VERSION_HISTORY', '更新履歴');
define('_CO_ICMS_WARNING_BETA', "このモジュールはβバージョンです。動作保証はできません。βバージョンは現在開発中と言う意味を表しています。この公開はあくまでも<b>開発中のもののテストの目的</b>, です。現在運用しているサイトに正式な使用は<b>まだお控えいただくことを</b>おすすめします。");
define('_CO_ICMS_WARNING_FINAL', "このモジュールの動作保証はできません。確かに公開バージョンですが、様々な問題がある可能性は否定できません。そのためお使いになる際には十分にご注意の上、それぞれの責任の下にお使いいただくようお願いします。いかなる動作不具合もモジュール作者は責任を負うことはできませんことをご了承ください。");
define('_CO_ICMS_WARNING_RC', "このモジュールはＲＣバージョンです。動作保証はできません。ＲＣバージョンは評価用のバージョンと言う意味を表しています。この公開はあくまでも<b>最終チェックのため</b>, です。現在運用しているサイトに正式な使用は<b>まだお控えいただくことを</b>おすすめします。");
...
define('_CO_ICMS_WARNING_ALPHA', "このモジュールはαバージョンです。動作保証はできません。αバージョンは現在開発中と言う意味を表しています。この公開はあくまでも<b>開発中のもののテストの目的</b>, です。現在運用しているサイトに正式な使用は<b>まだお控えいただくことを</b>おすすめします。");
