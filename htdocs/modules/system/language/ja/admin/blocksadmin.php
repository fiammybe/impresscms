...
define("_AM_CENTER","中央寄せ");
define("_AM_VISIBLE","表示する");
...
define('_AM_CLONE', 'クローン');  // clone a block
define('_AM_CLONEBLK', 'クローン'); // cloned block
...
define("_CO_SYSTEM_BLOCKSADMIN_MID", "モジュール");
define("_CO_SYSTEM_BLOCKSADMIN_MID_DSC", "");
define("_CO_SYSTEM_BLOCKSADMIN_VISIBLE", "表示する");
