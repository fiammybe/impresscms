...
define("_AM_FINDUS","ユーザを見つける");
define("_AM_AVATAR","アバター（似顔絵）");
define("_AM_REALNAME","本名");
define("_AM_REGDATE","登録日");
define("_AM_EMAIL","メール");
define("_AM_PM","PM");
define("_AM_URL","URL");
define("_AM_PREVIOUS","<< 前のデータ");
define("_AM_NEXT","次のデータ >>");
define("_AM_USERSFOUND","%s ユーザいらっしゃいます");

define("_AM_ACTUS", "アクティブなユーザ数: %s");
define("_AM_INACTUS", "アクティブじゃないユーザ数: %s");
define("_AM_NOFOUND","ユーザが見つかりません");
define("_AM_UNAME","ユーザ名");
define("_AM_ICQ","ICQ番号");
define("_AM_AIM","AIMハンドル");
define("_AM_YIM","YIMハンドル");
define("_AM_MSNM","MSNMハンドル");
define("_AM_LOCATION","お住まい");
define("_AM_OCCUPATION","ご職業");
define("_AM_INTEREST","ご趣味");
define("_AM_URLC","ホームページ");
...
define("_AM_LASTLOGIN","前回ログイン");
define("_AM_POSTS","投稿した数");
define("_AM_ASC","Ascending order");
define("_AM_DESC","Descending order");
define("_AM_LIMIT","1ページあたりのユーザ数");
define("_AM_RESULTS", "検索結果");
define("_AM_SHOWMAILOK", "Accept mail");
define("_AM_MAILOK","ユーザーメール可能");
define("_AM_MAILNG","ユーザーメール不可能");
define("_AM_SHOWTYPE", "アクティブ");
