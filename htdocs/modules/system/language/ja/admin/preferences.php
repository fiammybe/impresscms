...
define("_MD_AM_DEBUGMODE", "開発者ダッシュボード");
...
define("_MD_AM_CAPTCHA_IMG", "イメージ");
define("_MD_AM_CAPTCHA_TXT", "Text");
define("_MD_AM_CAPTCHA_OFF", "使用不可");
...
define("_MD_AM_HIGHLIGHTER_OFF", "使用不可");
