...
define("_AM_CNRNU","新規ユーザを登録出来ませんでした。");
...
define('_AM_BADPWD','パスワード不良です。パスワードにはユーザ名を含んではいけません。');
