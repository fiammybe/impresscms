...
define("_AM_LEFT","左对齐");
define("_AM_RIGHT","右对齐");
define("_AM_CENTER","中间对齐");
define("_AM_VISIBLE","可见");
...
define('_AM_CLONEBLK', '克隆'); // cloned block
...
define("_CO_SYSTEM_BLOCKSADMIN_VISIBLE", "可见");
