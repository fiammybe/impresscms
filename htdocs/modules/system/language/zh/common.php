...
define('_CO_ICMS_CATEGORY_IMAGE', '图像');
...
define('_CO_ICMS_DEVELOPER_CREDITS', '创建');
define('_CO_ICMS_DEVELOPER_EMAIL', '电子邮箱');
...
define('_CO_ICMS_GOTOMODULE', '开始模块');
...
define('_CO_ICMS_MODULE_BUG', '报告该模块的bug');
define('_CO_ICMS_MODULE_DEMO', '演示网站');
define('_CO_ICMS_MODULE_DISCLAIMER', '免责声明');
define('_CO_ICMS_MODULE_FEATURE', '对模块提出建议');
...
define('_CO_ICMS_MODULE_SUBMIT_FEATURE', '希望新增功能');
define('_CO_ICMS_MODULE_SUPPORT', '官方支持网站');
...
define('_CO_ICMS_WARNING_BETA', "本模块不附带任何保证承诺。模块尚在BETA版, 表示它还在开发中。发布这种版本是为了<b>测试</b> ，<b>强烈建议</b>你不要应用于实际的网络环境中。");
define('_CO_ICMS_WARNING_FINAL', "本模块不附带任何保证承诺。尽管这已不是BETA版，但在开发中。你可将模块用于实际的网络环境，但模块开发者不对由此产生的任何问题负担任何责任。");
define('_CO_ICMS_WARNING_RC', "本模块不附带任何保证承诺。 这是候选发布版，模块仍在开发中，本版本不会应用于实际的网络环境。 模块开发者不对此模块产生的任何问题负担任何责任。");
...
define('_CO_ICMS_WARNING_ALPHA', "本模块不附带任何保证承诺。模块尚在BETA版, 表示它还在开发中。发布这种版本是为了<b>测试</b> ，<b>强烈建议</b>你不要应用于真实的生产环境中。");
